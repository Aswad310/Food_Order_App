            ...
            if(isset($_GET['id'])){
                ...
                if($res==true){
                    ...
                    if($count==1){
                        ...
                        $_SESSION["category-not-found"]= "<div class='failure'>Category not  found</div>";
    ...
    if(isset($_POST['submit'])){
        ...
        if(isset($_FILES['image']['name'])){
            ...
            if($image_name!=""){
                ...
                if($upload==false){
                    // set message 
                    $_SESSION['upload']= "<div class='failure'>Failed to Update Image!</div>";
                ...
                if($current_image!=""){
                    ...
                    if($remove==false){
                        ...
                        $_SESSION['failed-remove']= "<div class='failure'>Failed to Remove Category Image</div>";
